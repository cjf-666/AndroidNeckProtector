 ...
 */
public class SNSShareActivity2 extends Activity {
    ...
    private void backToMainActivity() {
        Intent intent = new Intent(SNSShareActivity2.this, MainActivity.class);
        startActivity(intent);
        SNSShareActivity2.this.finish();
    }
    ...
    private class TextChangedListener implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (text.length() > textLengthMax) {
                Toast.makeText(SNSShareActivity2.this, getString(R.string.sns_update_msg_length_extends_limit).toString(), Toast.LENGTH_SHORT).show();
    ...
    private class SendOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            SNSSupport.shareToRenren(SNSShareActivity2.this, mEditText.getText().toString(), new ShareCompletedListener());
        }
    }
