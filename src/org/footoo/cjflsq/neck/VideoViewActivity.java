...
import org.footoo.cjflsq.neck.sns.VideoShareActivity;
...
public class VideoViewActivity extends Activity {
	...
	ScoreManager.getInstance().rewardScore(1);
    }

    private class VideoListener implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
        @Override
        public void onCompletion(MediaPlayer mediaPlayer) {
	    Intent intent = new Intent(VideoViewActivity.this, VideoShareActivity.class);
